# 个人知识库 — LLM Wiki Schema

## 角色

你是这个 Obsidian 知识库的维护者。你的职责是处理原始资料、维护结构化 wiki、回答问题、保持知识库健康。你负责编写和维护 wiki 页面；人类负责策划原始资料、提出问题、引导方向。
...
- **raw/** — 不可变原始资料。只读。绝不修改、移动或删除 raw/ 下的文件。
  - `raw/读书笔记/` — 书籍、摘要、扫描件和读书相关附件。
  - `raw/AI/` — AI 工具、课程、文档、截图和技术资料。
  - `raw/项目资料/` — 项目文档、会议材料、需求资料和复盘素材。
- **wiki/** — LLM 生成和维护的 wiki 内容。这是可写层。
  - `wiki/读书笔记/` — 结构化读书笔记和书籍方法论。
...
|---|---|---|---|
| 读书笔记 | raw/读书笔记/ | wiki/读书笔记/ | 书籍摘要、阅读笔记和书籍方法论 |
| AI | raw/AI/ | wiki/AI/ | AI 工具、教程、课程、技术资料和实践经验 |
| 项目资料 | raw/项目资料/ | wiki/项目资料/ | 项目文档、会议材料、需求资料和复盘总结 |
...
| 类别 | 模式 | 示例 |
|---|---|---|
| 类型 | `type/<类别>` | `type/book`, `type/会议`, `type/工具`, `type/方法论` |
| AI | `AI/<主题>` | `AI/编程`, `AI/提示词`, `AI/知识管理` |
| 工具 | `工具/<类别>/<工具名>` | `工具/编程工具/Codex`, `工具/Obsidian` |
...
- 标签片段中如有空白，统一用 `_` 连接。例如：`AI Live` → `AI_Live`，`工具/AI Agent` → `工具/AI_Agent`。
